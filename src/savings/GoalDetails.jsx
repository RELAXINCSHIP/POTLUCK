...
const GoalDetails = ({ onNavigate }) => {
    const [saved, setSaved] = useState(328450);
    const target = 385000;
    ...
    const handleTopUp = (amt) => {
        ...
        if (!val || val <= 0) return;
        setSaved(prev => Math.min(prev + val, target));
        setTopUpAmt('');
        setShowTopUp(false);
    ...
    return (
        <div className="savings-app page-transition">
            ...
            <div className="goal-hero">
                <img src="https://images.unsplash.com/photo-1617788138017-80ad40651399?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" alt="Porsche" className="hero-img" />
                <div className="hero-overlay"></div>
            </div>

            <div className="content">
                <h1 style={{ fontSize: '26px', fontWeight: 700, marginBottom: '8px', letterSpacing: '-0.5px' }}>Porsche 718 Cayman</h1>
                <div style={{
